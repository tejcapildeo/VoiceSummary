...
This is a first step. I'd like to expand this into something bigger, tailoring it specifically to a use case (for example doctor and patient consultations, and then a medical report is generated).

You can find the app over here:
https://voicesummary.streamlit.app/
